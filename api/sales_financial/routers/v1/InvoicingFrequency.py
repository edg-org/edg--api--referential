...
from api.sales_financial.services.InvoicingFrequencyService import InvoicingFrequencyService
from api.sales_financial.schemas.InvoicingFrequencySchema import (
...
async def list(skip: int=0, limit: int=100, frequencyService: InvoicingFrequencyService = Depends()):
...
async def get(code: int, frequencyService: InvoicingFrequencyService = Depends()):
...
async def create(data: List[CreateInvoicingFrequency], frequencyService: InvoicingFrequencyService = Depends()):
...
async def update(code: int, data: InvoicingFrequencyBase, frequencyService: InvoicingFrequencyService = Depends()):
