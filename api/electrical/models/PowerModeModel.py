...
class PowerModeModel(EntityMeta):
    __tablename__ = "power_modes"
    ...
    electric_meters = relationship("ElectricMeterModel", back_populates="power_mode")
    subscription_types = relationship("SubscriptionTypeModel", back_populates="power_mode")