...
@supplylineRouter.post(
    "/",
    summary="Creation router a supply line type",
    description="This router allows to create a supplyline type",
...
@supplylineRouter.put(
    "/{code}",
    summary="Update router a supply line type",
    description="This router allows to update a supplyline type",
    response_model=SupplyLineTypeSchema,
)
async def update(
    code: int,
